            ...
            <div className='content-item'>
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="public\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="public\Picture\Group1.png" alt="Communicative icon"></img>
                    </div>
                ...
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="public\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="public\Picture\Group2.png" alt="Professional icon"></img>
                    </div>
                ...
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="public\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="public\Picture\Group 243.png" alt="Collaborative icon"></img>
                    </div>
                ...
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="public\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="public\Picture\Group 242.png" alt="Fast learning icon"></img>
                    </div>
