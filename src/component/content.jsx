        ...
        <div className='content-details'>
            ...
            <div className='content-item'>
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="src\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="src\Picture\Group1.png"></img>
                    </div>
                ...
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="src\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="src\Picture\Group2.png"></img>
                    </div>
                ...
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="src\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="src\Picture\Group 243.png"></img>
                    </div>
                ...
                <div className='content-sub-item'>
                    <div className='circle'>
                        <img className="ellipse"src="src\Picture\Ellipse 44.png"></img>
                            <img className="in-ellipse-icon"src="src\Picture\Group 242.png"></img>
                    </div>
